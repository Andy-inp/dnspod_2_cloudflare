    ...
    for t in thread_list:
        ...
        for r in record_data:
            if r['type'] != 'NS':
                ...
                record_list.put(json.dumps(tmp_dict))
    thread_list.clear()


    # 3、从redis获取记录，导入CloudFlare
    while record_list.qsize() > 0:
        new_record = json.loads(record_list.get()[1])
...
if __name__ == '__main__':
    ...
    record_list = RedisQueue(list1, redis_host, redis_port, redis_pwd)
